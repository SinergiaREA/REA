...
export class CalculosFiscalesModel {
    ...
    /**
     * Calcula la retención de ISR RESICO (1.25%).
     * @param {number} subtotal 
     * @returns {number} Monto de la retención
     */
    calcularRetencion(subtotal) {
        return parseFloat((subtotal * this.RETENCIONES.ISR_RESICO).toFixed(2));
    }
}
